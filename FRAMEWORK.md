...
| Role | Class | One-line charter |
|---|---|---|
| implementer | efficient | One brief, one branch, one objective; evidence or it didn't happen |
| researcher | efficient | Replace guessing with labeled findings: fact / inference / unknown / recommendation |
| reviewer | strong | Fresh-context auditor; assumes the implementation may be wrong |
| security | strong | Vulnerabilities, secrets, dependency risk; never merges, never touches prod |
| devops | efficient | CI/CD and infra config as reviewable diffs; nothing production-affecting unaided |
...
11. Strong models for high-leverage reasoning, efficient models for execution.
